...
Write a function called sum() that takes in two numbers as arguments and then returns
 ...
 concatenated string that EXACTLY follows this example and uses the values that were input into the function:
...
function sum(a, b) { //eslint-disable-line
  var result= a+b;
  var myString= "The sum of "+ a+ " and " +b+ " is "+ result+"."
  var myarray=[result,myString]
  console.log(myarray);
  return myarray;
...
and when you think it is finished, uncomment the call for the testMultiply() function and see if the test passes.*/

// Write your code here
function multiply(a, b) { //eslint-disable-line
  var result= a *b;
  var myString= "The product of "+ a+ " and " +b+ " is "+ result+"."
...
Test this function by hand in the console to get it working, and when you think it is finished, uncomment the call for the testSumAndMultiply() function 
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
 ...
 {
    sum=sum+sumArray[i];
    multiply=multiply*sumArray[i];
   
  
 }
var myString= a  +" and "+b +" and "+ c+" sum to "+ sum+".";
var multiString= "The Product of  "+ a  +" and "+b +" and "+ c+" is "+ multiply+".";
  var myArray=[sum,multiply, myString, multiString]
  console.log(myArray);
  return myArray;
